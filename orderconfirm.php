		...
		<div class="row">
			...
			<div class="col-3 cart-sum">
				<div class="cart-sidebar">
					<div class="cart-sum-title">Address Details
						<hr>
					</div>
...
END;
	...
	$emailer = new Emailer();
$mailSent =	$emailer->send($cus_add, $subject, $message, implode("\r\n", $headers));
	
	
		if ($mailSent) {
			echo "<div class=\"order-success\">A confirmation email has been sent to the email address provided</p>";
			echo "<div class=\"order-success\">Thank you for your sale.</div>";
			$_SESSION['cart'] = "";
		} else {
