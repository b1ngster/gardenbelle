...
<div class="container">
    <div class="admin">
        ...
        <form method="post" action="/mng/mng_content.php" enctype="multipart/form-data">
            ...
            <p><input type="text" name="plant_indoor_start" placeholder="Name" /></p>
            <p><input type="text" name="plant_indoor_end" placeholder="Category" /></p>
            <p><input type="text" name="plant_outdoor_start" placeholder="Price" /></p>
            <p><input type="text" name="plant_outdoor_end" placeholder="Category" /></p>
            <p><input type="text" name="harvest_start" placeholder="Price" /></p>
