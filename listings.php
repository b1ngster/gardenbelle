...
if (isset($_GET['searchterm'])) {
	$check = mysqli_query($dbconnect, "SELECT * FROM `product` WHERE `p_species` LIKE '%{$_GET['cat']}%'");
} 
if (isset($_GET['searchterm'])) {
	...
	$check = mysqli_query($dbconnect, "SELECT * FROM `product` WHERE `p_variety`='{$_GET['var']}'");
} else {
...
if (isset($_GET['cat'])) {
	$result = mysqli_query($dbconnect, "SELECT * FROM `product` WHERE `p_species` LIKE '%{$_GET['cat']}%' LIMIT $numPP OFFSET $fetchOffset");
 ...
 (isset($_GET['searchterm'])) {
	...
	// Display the Category
	$result = mysqli_query($dbconnect, "SELECT * FROM `product` WHERE `p_variety`='{$_GET['var']}' LIMIT $numPP OFFSET $fetchOffset");
} else {
