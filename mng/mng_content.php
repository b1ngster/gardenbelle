        ...
        */
        ...
        if ($mainSize > MAX_SIZE || $thumbSize > MAX_SIZE) {
            ...
            */
            switch ($mainExt) {
                case "jpg":
                    $mainScr = imagecreatefromjpeg($upMain);
                    break;
                case "jpeg":
                    $mainScr = imagecreatefromjpeg($upMain);
                    break;
                case "png":
                    $mainScr = imagecreatefrompng($upMain);
                    break;
                case "gif":
                    $mainScr = imagecreatefromgif($upMain);
                    break;
            }
            switch ($thumbExt) {
                case "jpg":
                    $thumbScr = imagecreatefromjpeg($upThumb);
                    break;
                case "jpeg":
                    $thumbScr = imagecreatefromjpeg($upThumb);
                    break;
                case "png":
                    $thumbScr = imagecreatefrompng($upThumb);
                    break;
                case "gif":
                    $thumbScr = imagecreatefromgif($upThumb);
                    break;
            }
...
*/
    ...
    if (
        $main && (!validExtension($mainExt)) || ($thumb && !validExtension($thumbExt))
    ) {
        $_SESSION['message'] = "Unkown Image Extention";
        $errors = true;
